...
from tkinter import *
import random 
import pickle # to store data in .pickle file
import time
...
# client,addr = first_player_socket.accept()
...
window = Tk() 
window.title("Snake game (Monogram)") 
...
# start_new_thread(handle_connection, (client, addr))
window.mainloop()
