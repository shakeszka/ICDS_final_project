            ...
            if len(msg) > 0:
                ...
                if msg["action"] == "login":
                    ...
                    if self.group.is_member(name) != True:
                        ...
                        self.name_2_keys[msg["name"]] = msg["public_key"]
...
# ==============================================================================
    def handle_msg(self, from_sock):
        ...
        if len(msg) > 0:
            ...
            elif msg["action"] == "send public key and group member":
                public_key = msg["public key"]
                from_name = self.logged_sock2name[from_sock]
                self.keys[from_name] = public_key
                mysend(from_sock, json.dumps(
                    {"action": "send public key", "results": public_key}))
# ==============================================================================
...
# ==============================================================================
                ...
                for g in the_guys:
                    ...
                    mysend(
                        to_sock, json.dumps(
                        {"action": "exchange", "from": from_name, "message": encrypt.encryption(message, self.name_2_keys[g])}))
